        ...
        <RetroWindow title="welcome.txt" variant="purple" className="w-full">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex gap-4 pt-8">
              <a
                href="#about"
                className="px-4 py-2 bg-[#c4b5fd] border-2 border-[#1a1a2e] font-mono text-base sm:text-lg text-[#1a1a2e] hover:bg-[#A38DFC] transition-colors shadow-[4px_4px_0px_0px_rgba(26,26,46,0.8)] hover:shadow-[2px_2px_0px_0px_rgba(26,26,46,0.8)] hover:translate-x-[2px] hover:translate-y-[2px]"
              >
